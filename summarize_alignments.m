...
% Tami Lieberman, March 2013
% Displays results from alignment in a heatmap of strain by parameter set
% Only interprets output from bowtie2 alignments
% Visualize alignments later with choose_alignment_parameters(directory)
