function  generate_diversity_struct_single_sample(SampleDir, SampleName, p, window_size)
...
save(['intermediate_diversity_matfiles/countsatp_' SampleName], 'Countsi', 'FWindowsi', 'CWindowsi')
