function [annotations allannotations, diversityannotations, isolateannotations] = div_clickable_table_only_S(muts, dpos, ipos, calls, cnts, dwinds, iwinds, p, RefGenome, ScafNames, SampleNames, ChrStarts)
