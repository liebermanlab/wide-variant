...
----- (A) Setup ----------------------------------------
1. Set up reference genome folder in Reference_Genomes. Add fasta and genbank files. Genbank files must be ‘full’ versions. Name the fasta file genome.fasta. There may be multiple genebank files-- name each genebank file the name of the corresponding chromosome/scaffold in the fasta file (e.g. NC_002695.1.gb).
