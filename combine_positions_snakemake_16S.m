...
%% Provide positions of 16S rRNA gene copies
% Aro_Change: Provide positions of 16S gene copies

fprintf(1,'\nUsing 16S rRNA gene positions...\n');

% Reference genome has three copies of the 16S rRNA gene:
p_copy1 = 605771:607307; % first copy 
p_copy2 = 1530715:1532251; % second copy
p_copy3 = 1773256:1774792; % third copy

allp=unique([p_copy1; p_copy2; p_copy3;]);
p=sort(allp);
p=p(p>0); %remove any 0s
