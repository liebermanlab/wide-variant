...
if numel(controlMAF)>1
    good=div_single_sample_test_thresholds(data, params, controlMAF, coveragethresholds);
    removedbycontrol=div_single_sample_test_thresholds(data, params, ones(size(controlMAF)), coveragethresholds);
