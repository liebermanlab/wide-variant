...
for i=1:numel(annotations)
    ...
    tabledata(i,1:nonsamplecols)=[{annotations(i).type} {annotations(i).scafold} {annotations(i).pos} ...
        {annotations(i).locustag} {annotations(i).annotation} {annotations(i).AApos} {[annotations(i).nts]} ...
...
%         {isolateannotations(i).locustag} {isolateannotations(i).annotation} {[isolateannotations(i).nts]} ...
