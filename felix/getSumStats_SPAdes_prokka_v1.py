...
parser.add_argument("-s", dest='samples', help="Input file per subject including sample-IDs validated by kraken", type=argparse.FileType('rt'))
...
def get_numSample(samples_file):
    ...
    num_lines = sum(1 for line in samples_file)
    return num_lines
...
if __name__ == "__main__":
    ...
    # get sumary stats
    sampleCount = get_numSample(samplesFile)
    ...
    # write output
    subjectID = get_subjectID(samplesFile.name)
